...
<!-- script seleccionar -->                                                                                                     <script>
                                                                                                                                    $('#btn_seleccionar_<?php echo $producto['id_producto']; ?>').click(function(){ 
                                                                                                                                        ...
                                                                                                                                        $('#stock_nuevo').val('<?php echo trim($producto['stock']);?>');                                                                                                                                  
                                                                                                                                        $('#cantidad_compra').val('');                                                                                                                                  
                ...
                <!-- primera fila --->              <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="codigo_producto" name="codigo_producto" type="text" value="<?php echo $codigo;?>" class="form-control" disabled>
                                                                    <input id="id_producto" name="id_producto" type="text" value="<?php echo $id_producto;?>"  class="form-control" hidden>
                                                                    <input id="id_producto_anterior" name="id_producto_anterior" type="text" value="<?php echo $id_producto;?>"  class="form-control" hidden>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="nombre">Producto</label>
                                                                    <input id="nombre" name="nombre" type="text" value="<?php echo $nombre_producto;?>" class="form-control" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="nombre_categoria">Categoría</label>
                                                                    <input id="nombre_categoria" name="nombre_categoria" value="<?php echo $nombre_categoria;?>" type="text" class="form-control" disabled>
                                                                    <input id="id_categoria" name="id_categoria" type="text" class="form-control" hidden>
                                                                </div>
                                                            </div> 
                                                    </div>
                ...
                <!-- segunda fila --->              <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="usuario_producto" type="text"  value="<?php echo $id_usuario;?>"  class="form-control" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <label for="descripcion">Descripción</label>
                                                                    <textarea name="descripcion" id="descripcion" cols="30" rows="2"   value=""   class="form-control" disabled><?php echo $descripcion;?></textarea>
                                                                </div>
                                                        </div>
                                                    </div>
                ...
                <!-- tercera fila --->              <div class="row">
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="stock" name="stock" type="number" class="form-control" style="background-color: #FFFF66;"   value="<?php echo $stock;?>"    disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="stock_minimo">Stock Mínimo</label>
                                                                    <input id="stock_minimo" name="stock_minimo" type="number"   value="<?php echo $stock_minimo;?>"   class="form-control"  disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="stock_maximo">Stock Máximo</label>
                                                                    <input id="stock_maximo" name="stock_maximo"_max type="number"   value="<?php echo $stock_maximo;?>"   class="form-control" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="precio_compra">Precio Compra</label>
                                                                    <input id="precio_compra" name="precio_compra" type="number"   value="<?php echo $precio_compra_producto;?>"   class="form-control" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="precio_venta">Precio Venta</label>
                                                                    <input id="precio_venta" name="precio_venta" type="number"   value="<?php echo $precio_venta_producto;?>"  class="form-control" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <label for="fecha_ingreso">Fecha Ingreso</label>
                                                                    <input id="fecha_ingreso" name="fecha_ingreso" type="date"   value="<?php echo $fecha_ingreso;?>"   class="form-control" disabled>
                                                                </div>
                                                            </div> 
                                                    </div>
...
<!-- columna imagen --->                <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <center>
                                                    <img src="<?php echo $imagen; ?>" id="imagen_producto" alt="">
                                                </center>
                                            </div>
                                        </div>
                                </div>
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                ...
                                                                                                <?php   $contador_prov = 0;
                                                                                                        foreach( $proveedores_datos as $proveedor ) { 
                                                                                                            ...
                                                                                                            $telefono_empresa_tabla = $proveedor['telefono_empresa'];
...
<!-- script seleccionar -->                                                                                                     <script>
                                                                                                                                    $('#btn_seleccionar_prov<?php echo $id_proveedor; ?>').click(function(){ 
                                                                                                                                        ...
                                                                                                                                        $('#telefono').val('<?php echo $telefono_empresa_tabla;?>');                                                                                                                                  
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="nombre_proveedor" name="nombre_proveedor" type="text" value="<?php echo $nombre_proveedor; ?>"  class="form-control prov" disabled>
                                                                    <input id="id_proveedor" name="id_proveedor"  value="<?php echo $id_proveedor; ?>"   type="text"class="form-control prov" hidden>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="celular">Celular</label>
                                                                    <input id="celular"  name="celular" type="number" value="<?php echo $celular; ?>"  class="form-control prov" disabled>
                                                                </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label for="email_proveedor">Email</label>
                                                                    <input id="email_proveedor" type="text" value="<?php echo $email_empresa; ?>"  class="form-control" disabled>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="telefono" name="telefono" type="number" value="<?php echo $telefono_empresa; ?>"  class="form-control" disabled>
                                                                    </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="empresa">Empresa</label>
                                                                        <input id="empresa" name="empresa" type="text" value="<?php echo $empresa; ?>"  class="form-control prov" disabled>
                                                                    </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="direccion">Dirección</label>
                                                                        <textarea name="direccion" id="direccion" class="form-control" cols="25" rows="2" disabled> <?php echo $direccion; ?></textarea>
                                                                    </div>
                                                        </div>
                                                    </div>
                                    </div>                              
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="numero_compra_disabled" name="numero_compra_disabled" value="<?php echo $nro_compra; ?>" class="form-control" disabled>
                                                        <input type="text" id="numero_compra" name="numero_compra" value="<?php echo $nro_compra; ?>" class="form-control" hidden>
                                                        <input type="text" id="id_compra" name="id_compra" value="<?php echo $id_compra; ?>" class="form-control" hidden>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="fecha_compra">Fecha </label>
                                                        <input type="date" id="fecha_compra" name="fecha_compra" value="<?php echo substr($fecha_compra, 0 , 10); ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="comprobante">Comprobante</label>
                                                        <input type="text" id="comprobante" name="comprobante"value="<?php echo $comprobante; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="precio_compra_compra">Precio compra</label>
                                                        <input type="text" id="precio_compra_compra" name="precio_compra_compra" value="<?php echo $precio_compra; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="cantidad_compra" name="cantidad_compra"  value="<?php echo $cantidad; ?>"  style="text-align: center;" class="form-control">
                                                        <input type="number" id="cantidad_compra_anterior" name="cantidad_compra_anterior"  value="<?php echo $cantidad; ?>"  style="text-align: center;" class="form-control" hidden>
                                                    </div>
                                                    <script>
                                                        ...
                                                        setearValoresStock();
                                                        function setearValoresStock(){
                                                            var stock = $('#stock').val() - $('#cantidad_compra').val();
                                                            $('#stock_actual').val(stock);
                                                            $('#stock_nuevo').val($('#stock').val());
                                                        }
                                                    </script>
                                                </div>
                                                <div class="col-md-12">
                                               ...
                                               <hr>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                    <button id="btn_guardar_compra" class="btn btn-success btn-block" type="button">Actualizar</button>
                                                ...
                                                <script>
                                                    $('#btn_guardar_compra').click(function(){
                                                        ...
                                                        var id_producto_anterior = $('#id_producto_anterior').val();
                                                        ...
                                                        var cantidad_compra_anterior =  $('#cantidad_compra_anterior').val();
                                                        ...
                                                        if (id_producto == ""){
                                                            ...
                                                            $.get(url, {
                                                                ...
                                                                id_compra:id_compra,
                                                                id_producto_anterior:id_producto_anterior,
                                                                ...
                                                                cantidad_compra_anterior:cantidad_compra_anterior
                                                            } , function(datos){
