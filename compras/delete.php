  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Eliminar Compra Nro <?php echo $nro_compra; ?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                ...
                <!-- primera fila --->              <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="id_producto" name="id_producto" type="text"  value="<?= $id_producto; ?>"  class="form-control" hidden>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                        ...
                                        <div class="card card-outline card-danger">
                                            ...
                                            <div class="card-body">
                                               ...
                                               <hr>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <button id="btn_eliminar_compra" class="btn btn-danger btn-block" type="button">Eliminar</button>
